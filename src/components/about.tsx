...
const About: React.FC = () => {
  return (
    <div className="bg-navy h-screen w-screen flex flex-col align-center content-center p-2 mt-24 pb-24">
      <div className="flex flex-col flex-wrap m-auto align-center content-center justify-start mx-12">
        ...
        <div className="text-m md:text-lg text-lslate w-full md:w-4/5 lg:w-3/5 2xl:w-1/2 break-words">
