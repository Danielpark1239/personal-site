...
const SkillListing:React.FC<SkillsProps> = ({ languages, frameworks, other }) => {
  return (
    <>
        ...
        <div className='-mx-2 grid grid-cols-2 lg:grid-cols-5 gap-6 mb-4'>
            {languages.map(
                ({name, image}: SkillListingProps, index: number) => (
                    <div className='p-6 shadow-lg shadow-gray-400 rounded-xl hover:scale-105 ease-in duration-300 hover:shadow-gold' key={index}>
