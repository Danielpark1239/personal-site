...
const About: React.FC = () => {
  return (
    <div className="h-screen md:h-screen flex items-center p-2 py-16">
      ...
      <div className="absolute bottom-0 left-0 w-full mb-12 flex items-end justify-center">
        <StaticImage className="animate-bounce w-16 h-16 fill-white" src="../../public/static/scroll-down.svg" alt='Scroll down' placeholder="blurred"></StaticImage>
      </div>
    </div>
  );
};
